...
import 'package:db_hotel/screens/home_screen/admin_home_screen/admin_home_screen.dart';
...
class AdminAuthScreen extends StatelessWidget {
  AdminAuthScreen({Key? key, required this.database}) : super(key: key);
  ...
  void _login(context) async {
    ...
    if (staff != null) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (context) => AdminHomeScreen(database: database)),
          (route) => false);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Admin Auth Screen"),
        centerTitle: true,
      ),
      body: Center(
        child: Row(
