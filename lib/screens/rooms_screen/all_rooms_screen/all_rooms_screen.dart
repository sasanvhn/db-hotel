...
class AllRoomsScreen extends StatefulWidget {
  const AllRoomsScreen({Key? key, required this.database}) : super(key: key);

  final AppDatabase database;
  @override
  AllRoomsScreenState createState() => AllRoomsScreenState();
}

class AllRoomsScreenState extends State<AllRoomsScreen> {
